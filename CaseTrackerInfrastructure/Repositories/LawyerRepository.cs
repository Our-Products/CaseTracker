...
namespace CaseTrackerInfrastructure.Repositories
{
    ...
    public class LawyerRepository : ILawyerRepository
    {
        ...
        /// </summary>
        public async Task<Lawyer?> GetByBarCouncilIdAsync(string barCouncilId)
        {
            return await _context.Lawyers
                .Include(x => x.User)
                .Include(x => x.LawFirm)
                .FirstOrDefaultAsync(x => x.BarCouncilId == barCouncilId);
        }

        /// <summary>
        /// Get all lawyers associated with a specific law firm asynchronously.
        /// </summary>
        public async Task<IEnumerable<Lawyer>> GetByLawFirmIdAsync(Guid lawFirmId)
        {
            return await _context.Lawyers
        ...
        /// </summary>
        public async Task<IEnumerable<Lawyer>> SearchByNameAsync(string fullName)
        {
            return await _context.Lawyers
